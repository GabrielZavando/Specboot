...
check SC-007 "package.json declares 0.6.1" \
  grep -qF -- '"version": "0.6.1"' "$PKGJSON"
check SC-007 ".specboot.json reflects frameworkVersion 0.6.1" \
  grep -qF -- '"frameworkVersion": "0.6.1"' "$SPECBOOTJSON"
