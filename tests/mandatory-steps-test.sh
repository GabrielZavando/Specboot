...
#   - Version 0.7.0 in package.json/.specboot.json (migrated pin: 0.6.4→0.7.0
#     in the plan-agent-git-permissions minor bump; precedent: 0.6.3→0.6.4
#     in the fix-consumer-mode bump, 0.6.2→0.6.3 in M-904/M-905)
